                    ...
                    <div className="form-body">
                      ...
                      <div className="col-md-4">
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityCategoryId} onChange={(event) => setNewctivityCategoryId(event.target.value)}
                            type="text"
                            id="activity-title"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityTitle} onChange={(event) => setNewActivityTitle(event.target.value)}
                            type="text"
                            id="activity-title"
                            className="form-control"
                            name="acttitle"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityDescription} onChange={(event) => setNewActivityDescription(event.target.value)}
                            type="text"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityImageUrls1} onChange={(event) => setNewActivityImageUrls1(event.target.value)}
                            type="text"
                          ...
                          />
                          <br/>
                          <input value={newActivityImageUrls2} onChange={(event) => setNewActivityImageUrls2(event.target.value)}
                            type="text"
                            id="activity-imgurl-link"
                            className="form-control"
                            name="activityimglink []"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityPrice} onChange={(event) => setNewActivityPrice(parseInt(event.target.value))}
                            type="number"
                            id="activity-price"
                            className="form-control"
                            name="actprice"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityPriceDisc} onChange={(event) => setNewActivityPriceDisc(event.target.value)}
                            type="number"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityRating} onChange={(event) => setNewActivityRating(event.target.value)}
                            type="number"
                            id="activity-rating"
                            className="form-control"
                            name="actrating"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityReview} onChange={(event) => setNewActivityReview(event.target.value)}
                            type="number"
                            id="activity-review"
                            className="form-control"
                            name="actreview"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityFacilities} onChange={(event) => setNewActivityFacilities(event.target.value)}
                            type="text"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityAddress} onChange={(event) => setNewActivityAddress(event.target.value)}
                            type="text"
                            id="activity-address"
                            className="form-control"
                            name="actaddress"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityProvince} onChange={(event) => setNewActivityProvince(event.target.value)}
                            type="text"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityCity} onChange={(event) => setNewActivityCity(event.target.value)}
                            type="text"
                            id="activity-city"
                            className="form-control"
                            name="actcity"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={newActivityMap} onChange={(event) => setNewActivityMap(event.target.value)}
                            type="text"
                            id="activity-map"
                            className="form-control"
                            name="actmap"
                ...
                <div className="card" key={item.id}>                  
                    <div className="card-content">
                      ...
                      <div className="card-footer d-flex justify-content-between">
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityCategoryId} onChange={(event) => setEditActivityCategoryId(event.target.value)}
                            type="text"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityName} onChange={(event) => setEditActivityName(event.target.value)}
                            type="text"
                            id="activity-title"
                            className="form-control"
                            name="acttitle"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityUrl1} onChange={(event) => setEditActivityUrl1(event.target.value)}
                            type="text"
                            id="activity-imgurl-link"
                            className="form-control"
                            name="activityimglink[]"
                          ...
                          <input value={editActivityUrl2} onChange={(event) => setEditActivityUrl2(event.target.value)}
                            type="text"
                            id="activity-imgurl-link"
                            className="form-control"
                            name="activityimglink[]"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityPrice} onChange={(event) => setEditActivityPrice(parseInt(event.target.value))}
                            type="number"
                            id="activity-price"
                            className="form-control"
                            name="actprice"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityPriceDisc} onChange={(event) => setEditActivityPriceDisc(event.target.value)}
                            type="number"
                            id="activity-price-discount"
                            className="form-control"
                            name="actpricedisc"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityRating} onChange={(event) => setEditActivityRating(event.target.value)}
                            type="number"
                            id="activity-rating"
                            className="form-control"
                            name="actrating"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityReviews} onChange={(event) => setEditActivityReviews(event.target.value)}
                            type="number"
                            id="activity-review"
                            className="form-control"
                            name="actreview"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityFacilities} onChange={(event) => setEditActivityFacilities(event.target.value)}
                            type="text"
                            id="activity-facilities"
                            className="form-control"
                            name="actfacilities"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityAddress} onChange={(event) => setEditActivityAddress(event.target.value)}
                            type="text"
                            id="activity-address"
                            className="form-control"
                            name="actaddress"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityProvince} onChange={(event) => setEditActivityProvince(event.target.value)}
                            type="text"
                            id="activity-province"
                            className="form-control"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityCity} onChange={(event) => setEditActivityCity(event.target.value)}
                            type="text"
                            id="activity-city"
                            className="form-control"
                            name="actcity"
                        ...
                        <div className="col-md-8 form-group">
                          <input value={editActivityMaps} onChange={(event) => setEditActivityMaps(event.target.value)}
                            type="text"
                            id="activity-map"
                            className="form-control"
                            name="actmap"
