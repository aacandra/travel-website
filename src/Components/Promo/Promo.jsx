                        ...
                        <div className="row">
                          ...
                          <div className="col-md-8 form-group">
                            <input
                              ...
                              value={newTitlePromo}
                              onChange={(event) =>
                                setNewTitlePromo(event.target.value)
                              }
                          ...
                          <div className="form-group mb-3">
                            ...
                            <textarea
                              ...
                              onChange={(event) =>
                                setNewDescriptionPromo(event.target.value)
                              }
                          ...
                          <div className="form-group mb-3">
                            ...
                            <textarea
                              ...
                              value={newTermPromo}
                              onChange={(event) =>
                                setNewTermPromo(event.target.value)
                              }
                          ...
                          <div className="col-md-8 form-group">
                            <input
                              ...
                              value={newCodePromo}
                              onChange={(event) =>
                                setNewCodePromo(event.target.value)
                              }
                          ...
                          <div className="col-md-8 form-group">
                            <input
                              ...
                              value={newClaimPromo}
                              onChange={(event) =>
                                setNewClainPromo(parseInt(event.target.value))
                              }
                          ...
                          <div className="col-md-8 form-group">
                            <input
                              ...
                              value={newImagePromo}
                              onChange={(event) =>
                                setNewImagePromo(event.target.value)
                              }
